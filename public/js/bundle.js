...
var stripe = Stripe('pk_test_51KG1zECMxSvGV20d0rsVEy8SyZF41hXRZ4XdFUr54ZIoFKJHYmnjwYQdhgskT3pPsV7AREqfdqiA5JKBCBzN93J200AVJCkwxL');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) using Stripe Creaate checkout form + chance credit card
