...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJ1a2hhaWxhbGkiLCJhIjoiY2t2N3hmMXhsMGdyNDJvbWd5aHpycW9qdiJ9._JhGkBDtuPA0Wn66141z8w';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/abukhailali/ckv7xv1tt6b3a15mpn9qgvmzm',
    // style URL
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"upadateSettings.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:13000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:13000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
exports.upadateSettings = upadateSettings;
...
var _upadateSettings = require("./upadateSettings");
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  (0, _upadateSettings.upadateSettings)({
    name: name,
    email: email
  }, 'data');
});
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); // this 'Updating...' will appear to the user while changing the password on the button
            ...
            _context.next = 7;
            return (0, _upadateSettings.upadateSettings)({
          ...
          case 7:
            ...
            document.querySelector('.btn--save-password').textContent = 'Save password'; // resetting the fields back to empty after changing the password
